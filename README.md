...
# 📖 Hello Rails React application ()front end <a name="about-project"></a>
...
- **We use API endpoint that selects a random greeting**
- **Display the random greeting in static view**

### Preview <a name="preview"></a>

## 🚀 Live Demo <a name="live-demo"></a>
- Run application on local server (http://localhost:3001/)
...
```sh
  git clone git@github.com:sergskol/hello_react_front_end.git
...
Feel free to check the [issues page](https://github.com/SergSkol/hello_react_front_end/issues).
